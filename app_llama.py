...
model_id_lists = ['llama-2-7b-chat-hf', 'Chinese-Llama-2-7b']
model_path = '/app/models/'
model_name = sys.argv[1]
model_id = model_path + model_name
if model_name not in model_id_lists:
    sys.exit(0)
...
if torch.cuda.is_available():
    ...
    def chat(message, history, system_prompt, max_new_tokens):
        response = f"This demo does not work on CPU."
